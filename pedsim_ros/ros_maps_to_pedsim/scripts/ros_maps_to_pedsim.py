...
def add_waypoints_and_agent(scenario, agents_info):
    ...
    # agents_keys = agents_info.keys() #keys() for python2, list for python3#
    agents_keys = list(agents_info)
...
def scenario_from_map(map_image, map_metadata):
    ...
    for x in range(x_min, x_max): # 'xrange' for python, 'range' for python3
